...
<br><br>The output csv is an input file to the video generator Pyramid.py which reads the csv and produces Pyramid.mp4 which illustrates the result of the parameter choices over the selected life span
